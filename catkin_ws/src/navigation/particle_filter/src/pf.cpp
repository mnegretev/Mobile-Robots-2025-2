...
#define NOMBRE "Ramiro Sánchez Leonardo"
...
int main(int argc, char** argv)
{
    ...
    ros::param::param<int>  ("~N", N_particles, 750);
    ros::param::param<float>("~minX", init_min_x, 0.0);
    ros::param::param<float>("~minY", init_min_y, 0.0);
    ros::param::param<float>("~minA", init_min_a, 0.0);
    ros::param::param<float>("~maxX", init_max_x, 10.5);
    ros::param::param<float>("~maxY", init_max_y, 9.0);
    ros::param::param<float>("~maxA", init_max_a, 2.1);
    ros::param::param<int>  ("~ds", downsampling, 10);
    ros::param::param<float>("~s2s", sigma2_sensor, 0.02);
    ros::param::param<float>("~s2m", sigma2_movement, 0.02);
    ros::param::param<float>("~s2r", sigma2_resampling, 0.02);
